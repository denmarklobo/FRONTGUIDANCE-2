...
export default {
  ...
  methods: {
    async fetchSummary() {
      try {
        const response = await axios.get('http://26.11.249.89:8000/api/vio/summary');
    ...
    async fetchData() {
      try {
        ...
        const responseJHS = await axios.get('http://26.11.249.89:8000/api/vio/getJHS');
        ...
        const responseSHS = await axios.get('http://26.11.249.89:8000/api/vio/getSHS');
